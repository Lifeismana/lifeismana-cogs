...
def dank(self, avatar):
    ...
    hit = Image.open(f"{bundled_data_path(self)}/images/dank_hit.bmp").convert("RGBA").resize((40, 40))
    gun = Image.open(f"{bundled_data_path(self)}/images/dank_gun.bmp").convert("RGBA").resize((250, 205))
    faze = Image.open(f"{bundled_data_path(self)}/images/dank_faze.bmp").convert("RGBA").resize((60, 40))
